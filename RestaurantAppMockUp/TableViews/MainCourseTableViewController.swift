//
//  MainCourseTableViewController.swift
//  RestaurantAppMockUp
//
...
class MainCourseTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {

    @IBOutlet weak var tableView: UITableView!
    var menuItems: [String] = ["Ribeye Steak", "Chicken Stir Fry", "Irish Stew", "Mac Cheese"]
    var menuItemDetails: [String] = ["Juicy tender steak", "With stir fry veg", "Succulent pieces of beef in a rich gravy", "Made with mature chedder cheese"]
    var priceDetails: [String] = ["£25.00", "£7.00", "£5.00", "£4.00"]
