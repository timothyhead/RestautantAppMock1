//
//  AppetiserTableViewController.swift
//  RestaurantAppMockUp
//
...
class AppetiserTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    
    @IBOutlet weak var tableView: UITableView!
    var menuItems: [String] = ["Garlic Bread", "Cheese Plate", "Nachos", "Olives"]
    var menuItemDetails: [String] = ["A tasty bread", "A selection of fine cheeses", "Spicy and hot", "Stuffed"]
    var priceDetails: [String] = ["£4.50", "£7.00", "£5.00", "£4.00"]
    var orderTabBarItem = UIBarItem()
