...
class SidesTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {

    @IBOutlet weak var tableView: UITableView!
    var menuItems: [String] = ["French Fries", "Rice", "Grilled Veggies"]
    var menuItemDetails: [String] = ["With mayonnaise and tomato sauce", "Steamed rice", "Garden vegtables"]
